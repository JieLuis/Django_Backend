...
from .models import Cart, CartItem, Order, Product, OrderItem, ProductImage, Review, Customer, Collection
...
class ProductViewSet(ModelViewSet):
    queryset = Product.objects.prefetch_related('images', 'reviews').all()
